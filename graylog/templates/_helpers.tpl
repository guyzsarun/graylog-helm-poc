...
{{- else }}
    {{- printf "http://elasticsearch-master.%s.svc.managedcluster.local:9200" .Release.Namespace -}}
{{- end -}}
{{- end -}}
...
{{- else }}
    {{- printf "mongodb://%s-mongodb-headless.%s.svc.managedcluster.local:27017/graylog?replicaSet=rs0" .Release.Name .Release.Namespace -}}
{{- end -}}
{{- end -}}
